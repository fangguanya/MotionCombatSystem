 ...
 * Date: 10-30-2025
 * =============================================================================
 * DefenseDataTableFactory.h
 * Factory that creates a UDataTable preconfigured with FMCS_DefenseEntry as the row struct.
 */
...
#include "DefenseDataTableFactory.generated.h"

extern EAssetTypeCategories::Type MotionCombatSystemCategory;

UCLASS()
class MOTIONCOMBATSYSTEMEDITOR_API UDefenseDataTableFactory : public UFactory
{
    GENERATED_BODY()

public:
    // Constructor
    UDefenseDataTableFactory()
    {
        bCreateNew = true;
        bEditAfterNew = true;
    ...
    virtual UObject* FactoryCreateNew(UClass* Class, UObject* InParent, FName Name, EObjectFlags Flags, UObject* Context, FFeedbackContext* Warn) override
    {
        ...
        NewTable->RowStruct = FMCS_DefenseEntry::StaticStruct();
    ...
    */
    ...
    {
        return NSLOCTEXT("DefenseDataTableFactory", "DisplayName", "Defense Data Table");
    }
    ...
    */
    ...
    {
        return NSLOCTEXT("DefenseDataTableFactory", "ToolTip", "Create a new Motion Combat System Defense Data Table.");
    }
};
