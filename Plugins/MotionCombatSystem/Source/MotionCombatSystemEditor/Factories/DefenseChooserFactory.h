 ...
 * Date: 10-30-2025
 * =============================================================================
 * DefenseChooserFactory.h
 * Factory that creates a UMCS_DefenseChooser object.
 */
...
#include "DefenseChooserFactory.generated.h"

extern EAssetTypeCategories::Type MotionCombatSystemCategory;

UCLASS()
class MOTIONCOMBATSYSTEMEDITOR_API UDefenseChooserFactory : public UFactory
{
    GENERATED_BODY()

public:
    // Constructor
    UDefenseChooserFactory()
    {
        bCreateNew = true;
        bEditAfterNew = true;
        SupportedClass = UBlueprint::StaticClass(); //UMCS_DefenseChooser
    }
    ...
    virtual UObject* FactoryCreateNew(UClass* Class, UObject* InParent, FName Name, EObjectFlags Flags, UObject* Context, FFeedbackContext* Warn) override
    {
        ...
        UClass* ParentClass = UMCS_DefenseChooser::StaticClass();
        ...
        return FKismetEditorUtilities::CreateBlueprint(
            ...
            FName("DefenseChooserFactory")
        );

        // return NewObject<UMCS_DefenseChooser>(InParent, Class ? Class : UMCS_DefenseChooser::StaticClass(), Name, Flags);
    }
    ...
    {
        return MotionCombatSystemCategory;
    }
    ...
    */
    ...
    {
        return NSLOCTEXT("DefenseChooserFactory", "DisplayName", "Defense Chooser");
    }
    ...
    */
    ...
    {
        return NSLOCTEXT("DefenseChooserFactory", "ToolTip", "Create a new Motion Combat System Defense Chooser.");
    }
};
